  ...
  private cargarProductosPorDefecto(){
    if(!localStorage.getItem(this.DB_PRODUCTS_KEY)){
      const mockProducts: Product[] = [
        ...
        { id: 1, name: 'Pan Frances', price: 3.00, image: 'https://www.recetasdesbieta.com/wp-content/uploads/2018/08/pan-frances-1.jpg', description: 'Pan recién horneado.', category: 'Harinas' },
        ...
        { id: 3, name: 'Galletas Field de Vainilla', price: 2.80, image: 'https://oechsle.vteximg.com.br/arquivos/ids/1890456-1000-1000/image-7db686787e2c426897ab06f991e87b77.jpg?v=637495395967800000', description: 'Snack saludable.', category: 'Snacks' },
        ...
        { id: 9, name: 'Papas Lays Clásicas', price: 2.50, image: 'https://aceleralastatic.nyc3.cdn.digitaloceanspaces.com/files/uploads/1499/1596226959-77-frito-lay-papas-lays-clasicas-70-jpg.jpg', description: 'Snack salado tradicional.', category: 'Snacks' },
        { id: 10, name: 'Cereal Ángel Mel', price: 1.50, image: 'https://images.rappi.pe/products/1719005557489_1719005555337_1719005550832.png', description: 'Hojuelas de maíz con miel.', category: 'Cereales' },
        { id: 11, name: 'Inca Kola 1.5L', price: 7.50, image: 'https://www.donbelisario.com.pe/media/catalog/product/2/1/2146463136.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=700&width=700&canvas=700:700&format=jpeg', description: 'El sabor que nos hace únicos.', category: 'Bebidas' },
        { id: 12, name: 'Plátano Seda', price: 3.00, image: 'https://arandanosdelhuerto.com/wp-content/uploads/2021/10/platano-seda-normal_1000x1000-1-450x450.png', description: 'Kilo de plátano fresco.', category: 'Frutas' },
        { id: 13, name: 'Jabón Bolívar', price: 5.50, image: 'https://corporacionliderperu.com/51237-large_default/bolivar-jabon-vida-x-190-gr-cuidado-total.jpg', description: 'Pack x3 para ropa limpia.', category: 'Detergentes' },
        { id: 14, name: 'Galletas Morochas', price: 1.20, image: 'https://grandcentral.pe/wp-content/uploads/2025/09/GCG086-M1.jpg', description: 'Galletas bañadas en chocolate.', category: 'Snacks' }
      ];
